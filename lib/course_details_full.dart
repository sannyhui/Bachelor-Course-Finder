...
class CourseDetailsFull extends StatefulWidget {
  ...
  _CourseDetailsFull createState() => _CourseDetailsFull();
}

class _CourseDetailsFull extends State<CourseDetailsFull> {
              ...
              Expanded(
                  child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        CourseFullTimeDetails courseDetail = widget.course.details[index];
                        return Padding(
